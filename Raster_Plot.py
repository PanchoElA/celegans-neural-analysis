...
# Obtener timestamps neurales como REFERENCIA ABSOLUTA
neural_timestamps = nwb.processing["CalciumActivity"]["SignalRawFluor"]["SignalCalciumImResponseSeries"].timestamps[:]
neural_data = np.array(nwb.processing["CalciumActivity"]["SignalRawFluor"]["SignalCalciumImResponseSeries"].data[:])
...
ax_vel.set_ylabel('Velocity\n(μm/s)', fontsize=10, fontweight='bold')
...
cbar.set_label('ΔF/F', fontsize=14, fontweight='bold')
